...
library(Seurat)
  ...
  # SCEVAN paper warns the results might be very bad if the initial choice of normal cells is wrong.
  # Thus, more than one seed should be tested.
...
sce_donor_subset_sample <- SCEVAN::pipelineCNA(donor_subset_sample_mat,
                                            ...
                                            #  AdditionalGeneSets =         # This could be used to add signatures of normal cells but I have not used it or found an example of using it.
                                               ...
                                               SCEVANsignatures = F)    # Stop SCEVAN from using references other than the dummy cell.
